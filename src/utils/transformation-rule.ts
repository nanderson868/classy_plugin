...
// import { type TransformationRule as CustomRule } from "@/settings";
// // import dom from "./dom";
...
// 	return plugin.settings.transformations.sort(
// 		(a, b) => Number(b.enabled.valueOf()) - Number(b.enabled.valueOf())
// 	);
// };
